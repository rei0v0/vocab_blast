...
class RewardAdForTokenNotifier extends StateNotifier<RewardAdState> {

  RewardAdForTokenNotifier() : super(const RewardAdState()) {
    createAd();
  }
  ...
  String rewardAdUnitId(){
    ...
    if (isDebug) {
      ...
      if (Platform.isAndroid) {
        ...
        return "ca-app-pub-9355531664192197/5926882313";
      } else {
        throw UnsupportedError("Unsupported platform");
      }
    }
