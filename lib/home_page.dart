...
final userSettingProvider = StateNotifierProvider<UserNotifier, UserSetting>((ref) {
  return UserNotifier();
});
...
class HomePage extends ConsumerWidget{
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final userInfo = ref.watch(userSettingProvider);
    final userNotifier = ref.read(userSettingProvider.notifier);
    final rewardAd = ref.read(rewardAdProvider.notifier);

    return Scaffold(
      appBar:PreferredSize(
        preferredSize: const Size.fromHeight(200.0), // AppBarの高さ
        child: Container(
          height: width * 3 / 5,
          width: width,
          ...
          child: SafeArea(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  const Text('Hello there!',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 30,color: Colors.black),),
                  const Spacer(),
                  Row(
