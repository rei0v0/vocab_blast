...
abstract class $RewardAdStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({RewardedAd? ad, bool isLoaded});
}
...
class _$_RewardAdState implements _RewardAdState {
  const _$_RewardAdState({this.ad = null, this.isLoaded = false});
  ...
  @override
  String toString() {
    return 'RewardAdState(ad: $ad, isLoaded: $isLoaded)';
  }
...
abstract class _RewardAdState implements RewardAdState {
  const factory _RewardAdState({final RewardedAd? ad, final bool isLoaded}) =
      _$_RewardAdState;
